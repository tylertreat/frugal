...
# as a test artifact
if [ -f ${frugalDir}/test/integration/log/unexpected_failures.log ]; then
    cp -r ${frugalDir}/test/integration/log/unexpected_failures.log /testing/artifacts/unexpected_failures.log
fi
