...
@Generated(value = "Autogenerated by Frugal Compiler (0.0.1)", date = "2016-01-06")
public class FFoo {
    ...
    public interface Iface {
         ...
         * @param event
         */
        public long blah(FContext context, int num, String Str, Event event) throws AwesomeException, TException;
    ...
    public static class Client implements Iface {
        ...
        public long blah(FContext ctx, int num, String str, Event event) throws AwesomeException, TException {
            FProtocol oprot = this.outputProtocol;
            BlockingQueue<Object> result = new ArrayBlockingQueue<>(1);
    ...
    public static class Processor implements FProcessor {
        ...
        private Map<String, FProcessorFunction> processorMap;
        ...
        public boolean process(FProtocol iprot, FProtocol oprot) throws TException {
        ...
        private static class Ping implements FProcessorFunction {
            ...
            public boolean process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
                Foo.ping_args args = new Foo.ping_args();
                try {
                    args.read(iprot);
                } catch (TException e) {
