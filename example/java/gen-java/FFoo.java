...
public class FFoo {
	 ...
	 */
	public interface Iface extends FBase.Iface {
	...
	public static class Client extends FBase.Client implements Iface {
	...
	public static class Processor extends FBase.Processor implements FProcessor {
