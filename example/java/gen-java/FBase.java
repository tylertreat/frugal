...
@Generated(value = "Autogenerated by Frugal Compiler (0.0.1)", date = "2016-1-22")
public class FBase {
		...
		public void basePing(FContext ctx) throws TException {
			...
			try {
				synchronized (WRITE_LOCK) {
					...
					Base.basePing_args args = new Base.basePing_args();
					args.write(oprot);
				...
				Base.basePing_result r = (Base.basePing_result) res;
			} finally {
			...
			return new FAsyncCallback() {
				public void onMessage(TTransport tr) throws TException {
					...
					try {
						...
						Base.basePing_result res = new Base.basePing_result();
						res.read(iprot);
						iprot.readMessageEnd();
						try {
							result.put(res);
	...
	protected Processor(Iface iface, java.util.Map<String, FProcessorFunction> processMap) {
		...
		private static class BasePing implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				iprot.readMessageEnd();
				Base.basePing_result result = new Base.basePing_result();
				try {
					this.handler.basePing(ctx);
				} catch (TException e) {
					TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing basePing: " + e.getMessage());
					synchronized (WRITE_LOCK) {
						oprot.writeResponseHeader(ctx);
						oprot.writeMessageBegin(new TMessage("basePing", TMessageType.EXCEPTION, 0));
						x.write(oprot);
