...
;
  ...
  public static class blah_args implements org.apache.thrift.TBase<blah_args, blah_args._Fields>, java.io.Serializable, Cloneable, Comparable<blah_args>   {
    ...
    private static final SchemeFactory STANDARD_SCHEME_FACTORY = new blah_argsStandardSchemeFactory();
    private static final SchemeFactory TUPLE_SCHEME_FACTORY = new blah_argsTupleSchemeFactory();
  ...
  public static class blah_result implements org.apache.thrift.TBase<blah_result, blah_result._Fields>, java.io.Serializable, Cloneable, Comparable<blah_result>   {
    ...
    private static final SchemeFactory STANDARD_SCHEME_FACTORY = new blah_resultStandardSchemeFactory();
    private static final SchemeFactory TUPLE_SCHEME_FACTORY = new blah_resultTupleSchemeFactory();
  ...
  public static class oneWay_args implements org.apache.thrift.TBase<oneWay_args, oneWay_args._Fields>, java.io.Serializable, Cloneable, Comparable<oneWay_args>   {
    ...
    private static final SchemeFactory STANDARD_SCHEME_FACTORY = new oneWay_argsStandardSchemeFactory();
    private static final SchemeFactory TUPLE_SCHEME_FACTORY = new oneWay_argsTupleSchemeFactory();
    ...
    public oneWay_args(oneWay_args other) {
      ...
      this.id = other.id;
      if (other.isSetReq()) {
        Map<Integer,String> __this__req = new HashMap<Integer,String>(other.req.size());
        for (Map.Entry<Integer, String> other_element : other.req.entrySet()) {

          Integer other_element_key = other_element.getKey();
          String other_element_value = other_element.getValue();

          Integer __this__req_copy_key = other_element_key;
