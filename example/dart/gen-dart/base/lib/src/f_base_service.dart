...
class FBaseClient implements FBase {

  FBaseClient(frugal.FServiceProvider provider) {
  ...
  Future basePing(frugal.FContext ctx) async {
    ...
    try {
      ...
      t_base.basePing_args args = new t_base.basePing_args();
      args.write(oprot);
  ...
  _recvBasePingHandler(frugal.FContext ctx, StreamController controller) {
    basePingCallback(thrift.TTransport transport) {
      try {
        ...
        t_base.basePing_result result = new t_base.basePing_result();
        result.read(iprot);
        iprot.readMessageEnd();
        controller.add(null);
      } catch(e) {
