...
;
	...
	public nested_thing(nested_thing other) {
		if (other.isSetThings()) {
			...
			for (thing elem168 : other.things) {
				thing elem169 = new thing(elem168);
				this.things.add(elem169);
			}
		}
	}
	...
	private static class nested_thingStandardScheme extends StandardScheme<nested_thing> {
				...
				switch (schemeField.id) {
					case 1: // THINGS
						if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
							...
							struct.things = new ArrayList<thing>(elem170.size);
							for (int elem171 = 0; elem171 < elem170.size; ++elem171) {
								thing elem172 = new thing();
								elem172.read(iprot);
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, nested_thing struct) throws org.apache.thrift.TException {
			...
			if (struct.things != null) {
				...
				for (thing elem173 : struct.things) {
					elem173.write(oprot);
				}
				oprot.writeListEnd();
				oprot.writeFieldEnd();
	...
	private static class nested_thingTupleScheme extends TupleScheme<nested_thing> {
		...
		public void write(org.apache.thrift.protocol.TProtocol prot, nested_thing struct) throws org.apache.thrift.TException {
			...
			if (struct.isSetThings()) {
				...
				for (thing elem174 : struct.things) {
					elem174.write(oprot);
				}
			}
		}
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, nested_thing struct) throws org.apache.thrift.TException {
			...
			if (incoming.get(0)) {
				org.apache.thrift.protocol.TList elem175 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
				struct.things = new ArrayList<thing>(elem175.size);
				for (int elem176 = 0; elem176 < elem175.size; ++elem176) {
					thing elem177 = new thing();
					elem177.read(iprot);
