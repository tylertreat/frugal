		...
		private static class Ping implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FRateLimitException.RATE_LIMIT_EXCEEDED, "ping", e.getMessage());
					return;
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
		...
		private static class Bleh implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FRateLimitException.RATE_LIMIT_EXCEEDED, "bleh", e.getMessage());
					return;
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
		...
		private static class GetThing implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FRateLimitException.RATE_LIMIT_EXCEEDED, "getThing", e.getMessage());
					return;
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
		...
		private static class GetMyInt implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FRateLimitException.RATE_LIMIT_EXCEEDED, "getMyInt", e.getMessage());
					return;
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
