	...
	public static class Client implements Iface {
		...
		protected static class InternalEventsPublisher implements Iface {
			...
			public void publishSomeList(FContext ctx, String user, java.util.List<java.util.Map<Long, Event>> req) throws TException {
				...
				for (java.util.Map<Long, Event> elem300 : req) {
					oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, elem300.size()));
					for (Map.Entry<Long, Event> elem301 : elem300.entrySet()) {
						long elem302 = elem301.getKey();
						oprot.writeI64(elem302);
						elem301.getValue().write(oprot);
					}
					oprot.writeMapEnd();
				}
				oprot.writeListEnd();
