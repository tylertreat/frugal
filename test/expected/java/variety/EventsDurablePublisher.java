...
@Generated(value = "Autogenerated by Frugal Compiler (2.3.0-RC3)", date = "2015-11-24")
public class EventsDurablePublisher {
	...
	public static class Client implements Iface {
		...
		protected static class InternalEventsPublisher implements Iface {
			...
			public InternalEventsPublisher(FDurableScopeProvider provider) {
			...
			public void publishSomeList(FContext ctx, String groupId, String user, java.util.List<java.util.Map<Long, Event>> req) throws TException {
				...
				for (java.util.Map<Long, Event> elem286 : req) {
					oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, elem286.size()));
					for (Map.Entry<Long, Event> elem287 : elem286.entrySet()) {
						long elem288 = elem287.getKey();
						oprot.writeI64(elem288);
						elem287.getValue().write(oprot);
					}
					oprot.writeMapEnd();
				}
				oprot.writeListEnd();
