...
class _blah(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "blah", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _bin_method(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "bin_method", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _param_modifiers(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "param_modifiers", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _underlying_types_test(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "underlying_types_test", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _getThing(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "getThing", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _getMyInt(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "getMyInt", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
...
class _use_subdir_struct(FProcessorFunction):
    ...
    async def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            async with self._lock:
                e = _write_application_exception(ctx, oprot, "use_subdir_struct", typ=TApplicationException.UNKNOWN, message=e.args[0])
            raise e from None
        async with self._lock:
            try:
                oprot.write_response_headers(ctx)
