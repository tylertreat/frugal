...
/// used to add logic around FTransport events, such as unexpected disconnects,
/// expected disconnects, failed reconnects, and successful reconnects.
///
...
abstract class FTransportMonitor {
  /// Called when the transport is closed cleanly by a call to [close] with no
  /// error.
