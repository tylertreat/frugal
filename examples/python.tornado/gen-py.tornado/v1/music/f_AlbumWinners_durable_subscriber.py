...
class AlbumWinnersDurableSubscriber(object):
    """
    ...
    def subscribe_ContestStart(self, ContestStart_handler):
        """
            ContestStart_handler: function which takes FContext, group_id, and list<Album>
        """
    ...
    def subscribe_TimeLeft(self, TimeLeft_handler):
        """
            TimeLeft_handler: function which takes FContext, group_id, and Minutes
        """
    ...
    def subscribe_Winner(self, Winner_handler):
        """
            Winner_handler: function which takes FContext, group_id, and Album
        """
