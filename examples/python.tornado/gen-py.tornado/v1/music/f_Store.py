    ...
    def process(self, ctx, iprot, oprot):
        ...
        with (yield self._lock.acquire()):
            try:
                ...
                raise _write_application_exception(ctx, oprot, "buyAlbum", ex_code=FApplicationException.RESPONSE_TOO_LARGE, message=e.message)
    ...
    def process(self, ctx, iprot, oprot):
        ...
        with (yield self._lock.acquire()):
            try:
                ...
                raise _write_application_exception(ctx, oprot, "enterAlbumGiveaway", ex_code=FApplicationException.RESPONSE_TOO_LARGE, message=e.message)
