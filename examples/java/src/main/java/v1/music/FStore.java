...
@Generated(value = "Autogenerated by Frugal Compiler (1.19.1)", date = "2016-10-13")
public class FStore {
		...
		private static class BuyAlbum implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FTransport.RATE_LIMIT_EXCEEDED, "buyAlbum", "rate limit exceeded");
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
		...
		private static class EnterAlbumGiveaway implements FProcessorFunction {
			...
			public void process(FContext ctx, FProtocol iprot, FProtocol oprot) throws TException {
				...
				try {
					...
					writeApplicationException(ctx, oprot, FTransport.RATE_LIMIT_EXCEEDED, "enterAlbumGiveaway", "rate limit exceeded");
				} catch (TException e) {
					synchronized (WRITE_LOCK) {
