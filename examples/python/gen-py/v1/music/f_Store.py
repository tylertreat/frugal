...
class _buyAlbum(FProcessorFunction):
    ...
    def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            with self._lock:
                e = _write_application_exception(ctx, oprot, "buyAlbum", ex_code=TApplicationExceptionType.INTERNAL_ERROR, message=e.message)
            raise e
        with self._lock:
            try:
...
class _enterAlbumGiveaway(FProcessorFunction):
    ...
    def process(self, ctx, iprot, oprot):
        ...
        try:
            ...
            with self._lock:
                e = _write_application_exception(ctx, oprot, "enterAlbumGiveaway", ex_code=TApplicationExceptionType.INTERNAL_ERROR, message=e.message)
            raise e
        with self._lock:
            try:
                oprot.write_response_headers(ctx)
