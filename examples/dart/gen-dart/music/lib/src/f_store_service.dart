...
abstract class FStore {
  ...
  Future<t_music.Album> buyAlbum(frugal.FContext ctx, String aSIN, String acct);
...
class FStoreClient implements FStore {
  ...
  Future<t_music.Album> _buyAlbum(frugal.FContext ctx, String aSIN, String acct) async {
