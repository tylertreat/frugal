...
import 'package:music/music.dart' as t_music;
...
class AlbumWinnersPublisher {
  ...
  Future publishWinner(frugal.FContext ctx, t_music.Album req) {
    return this._methods['Winner']([ctx, req]);
  }

  Future _publishWinner(frugal.FContext ctx, t_music.Album req) async {
...
class AlbumWinnersSubscriber {
  ...
  Future<frugal.FSubscription> subscribeWinner(dynamic onAlbum(frugal.FContext ctx, t_music.Album req)) async {
    var op = "Winner";
    var prefix = "store.";
    var topic = "${prefix}AlbumWinners${delimiter}${op}";
  ...
  _recvWinner(String op, frugal.FProtocolFactory protocolFactory, dynamic onAlbum(frugal.FContext ctx, t_music.Album req)) {
