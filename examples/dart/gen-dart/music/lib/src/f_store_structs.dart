...
class buyAlbum_result implements TBase {
  ...
  t_music.Album _success;
  static const int SUCCESS = 0;
  t_music.PurchasingError _error;
  ...
  t_music.Album get success => this._success;

  set success(t_music.Album success) {
  ...
  t_music.PurchasingError get error => this._error;

  set error(t_music.PurchasingError error) {
    this._error = error;
  }
  ...
  read(TProtocol iprot) {
    ...
    while(true) {
      ...
      switch(field.id) {
        ...
        case ERROR:
          if(field.type == TType.STRUCT) {
            error = new t_music.PurchasingError();
            error.read(iprot);
          } else {
            TProtocolUtil.skip(iprot, field.type);
          }
