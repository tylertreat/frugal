...
class Album implements TBase {
  ...
  List<t_music.Track> get tracks => this._tracks;

  set tracks(List<t_music.Track> tracks) {
    this._tracks = tracks;
  }
      ...
      switch(field.id) {
        case TRACKS:
          if(field.type == TType.LIST) {
            ...
            tracks = new List<t_music.Track>();
            for(int elem2 = 0; elem2 < elem0.length; ++elem2) {
              t_music.Track elem1 = new t_music.Track();
              elem1.read(iprot);
              tracks.add(elem1);
            }
            iprot.readListEnd();
