...
class FStoreClient implements FStore {
  ...
  frugal.FAsyncCallback _recvBuyAlbumHandler(frugal.FContext ctx, StreamController controller) {
  ...
  frugal.FAsyncCallback _recvEnterAlbumGiveawayHandler(frugal.FContext ctx, StreamController controller) {
