...
abstract class FStore {
  ...
  Future<t_v1_music.AUnion> some_union_thing(frugal.FContext ctx, t_v1_music.AUnion some_union);
}
...
class FStoreClient implements FStore {
  ...
  FStoreClient(frugal.FServiceProvider provider, [List<frugal.Middleware> middleware]) {
    ...
    this._methods['some_union_thing'] = new frugal.FMethod(this._some_union_thing, 'Store', 'some_union_thing', combined);
  }
  ...
  Future<t_v1_music.AUnion> some_union_thing(frugal.FContext ctx, t_v1_music.AUnion some_union) {
    return this._methods['some_union_thing']([ctx, some_union]) as Future<t_v1_music.AUnion>;
  }

  Future<t_v1_music.AUnion> _some_union_thing(frugal.FContext ctx, t_v1_music.AUnion some_union) async {
    var memoryBuffer = new frugal.TMemoryOutputBuffer(_transport.requestSizeLimit);
    var oprot = _protocolFactory.getProtocol(memoryBuffer);
    oprot.writeRequestHeader(ctx);
    oprot.writeMessageBegin(new thrift.TMessage("some_union_thing", thrift.TMessageType.CALL, 0));
    ...
    throw new thrift.TApplicationError(
      frugal.FrugalTApplicationErrorType.MISSING_RESULT, "some_union_thing failed: unknown result"
    );
  }
}
...
class some_union_thing_args implements thrift.TBase {
  static final thrift.TStruct _STRUCT_DESC = new thrift.TStruct("some_union_thing_args");
  static final thrift.TField _SOME_UNION_FIELD_DESC = new thrift.TField("some_union", thrift.TType.STRUCT, 1);

  t_v1_music.AUnion _some_union;
  static const int SOME_UNION = 1;


  some_union_thing_args() {
  }

  t_v1_music.AUnion get some_union => this._some_union;

  set some_union(t_v1_music.AUnion some_union) {
    this._some_union = some_union;
  }

  bool isSetSome_union() => this.some_union != null;
    ...
    switch(fieldID) {
      case SOME_UNION:
        if(value == null) {
          ...
          this.some_union = value as t_v1_music.AUnion;
        }
        break;
  ...
  read(thrift.TProtocol iprot) {
    ...
    while(true) {
      ...
      switch(field.id) {
        case SOME_UNION:
          if(field.type == thrift.TType.STRUCT) {
            some_union = new t_v1_music.AUnion();
            some_union.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
          }
          break;
  ...
  write(thrift.TProtocol oprot) {
    ...
    if(this.some_union != null) {
      oprot.writeFieldBegin(_SOME_UNION_FIELD_DESC);
      some_union.write(oprot);
      oprot.writeFieldEnd();
    }
    oprot.writeFieldStop();
    oprot.writeStructEnd();
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("some_union_thing_args(");

    ret.write("some_union:");
    if(this.some_union == null) {
      ret.write("null");
    } else {
      ret.write(this.some_union);
    }
...
class some_union_thing_result implements thrift.TBase {
  static final thrift.TStruct _STRUCT_DESC = new thrift.TStruct("some_union_thing_result");
  static final thrift.TField _SUCCESS_FIELD_DESC = new thrift.TField("success", thrift.TType.STRUCT, 0);

  t_v1_music.AUnion _success;
  static const int SUCCESS = 0;


  some_union_thing_result() {
  }

  t_v1_music.AUnion get success => this._success;

  set success(t_v1_music.AUnion success) {
    this._success = success;
  }
    ...
    switch(fieldID) {
      case SUCCESS:
        if(value == null) {
          ...
          this.success = value as t_v1_music.AUnion;
        }
        break;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("some_union_thing_result(");
