...
class AUnion(object):
    ...
    Attributes:
     ...
     - an_enum
    """
    def __init__(self, str=None, num=None, an_enum=None):
        self.str = str
        self.num = num
    ...
    def write(self, oprot):
        ...
        if self.num is not None:
            ...
            oprot.writeFieldEnd()
        if self.an_enum is not None:
            oprot.writeFieldBegin('an_enum', TType.I32, 3)
            oprot.writeI32(self.an_enum)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __hash__(self):
        ...
        value = (value * 31) ^ hash(self.an_enum)
        return value
